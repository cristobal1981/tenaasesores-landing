export const fiscalidadCanaria = {
  meta: {
    title: "Fiscalidad canaria: IGIC, REF y ZEC | tenaasesores",
    description:
      "Gestión de IGIC, AIEM y las ventajas del REF en Canarias, con orientación sobre la Zona Especial Canaria (ZEC) para empresas y autónomos en Tenerife.",
  },
  hero: {
    eyebrow: "Fiscalidad canaria",
    title: ["Fiscalidad canaria:", "IGIC, REF y ZEC"],
    lead: "Llevamos tu IGIC trimestre a trimestre. Te orientamos en las ventajas del REF, el AIEM cuando corresponde y, si tu actividad puede beneficiarse, en la Zona Especial Canaria.",
  },
  intro: {
    badge: "Por qué Canarias es distinta",
    title: ["Un régimen fiscal", "propio dentro de la UE"],
    description:
  ...
  topics: {
    badge: "Qué gestionamos",
    title: ["Lo que cubre", "la fiscalidad canaria"],
    items: [
      {
      ...
      {
        title: "AIEM: el arancel a la producción y la importación",
        description:
      ...
      {
        title: "ZEC: Impuesto de Sociedades al 4%",
        description:
  ...
  cta: {
    title: "¿Hablamos de tu fiscalidad canaria?",
    label: "Conversemos",
  },
} as const
